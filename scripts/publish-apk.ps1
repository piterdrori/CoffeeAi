...
if (-not $gh) {
    ...
    $releaseNotes = "CoffeeAI $version — fixes Let's Talk barge-in that cancelled replies; smoother voice conversation flow."
...
$appMeta = @{
    ...
    notes          = "CoffeeAI v$version - Let's Talk barge-in fix, smoother voice replies"
}
